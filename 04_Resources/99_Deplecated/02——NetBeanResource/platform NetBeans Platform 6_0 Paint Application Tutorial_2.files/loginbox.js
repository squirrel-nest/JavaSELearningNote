function show_login_form(username,logintext,logouttext,where) {
  ...
  if (where == "top") {
    if (username!='guest') {
      ...
      document.write('<tr><td colspan="2" class="align-left"><span class="font-11"><a href="http://www.netbeans.org/servlets/PasswordRequest">Forgot your password?</a></span></td></tr></table></form>');
    }
