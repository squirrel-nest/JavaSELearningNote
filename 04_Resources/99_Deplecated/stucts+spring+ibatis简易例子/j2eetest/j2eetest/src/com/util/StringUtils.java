...
public class StringUtils {
    ...
    */
     ...
     */
      ...
      * 从URL中获取参数存储到MAP
      * @param request
      * @param exceptionParamNames
      * @return
      */
     public static Map getParamsFromCurrentURL(HttpServletRequest request, String exceptionParamNames) {
    	String params = "";
    	...
    	while(e.hasMoreElements()){
    		...
    		while(st.hasMoreTokens()){
    			String exceptionName = (String)st.nextToken();
    			if(key.equals(exceptionParamNames)) continue outer;
    		}
