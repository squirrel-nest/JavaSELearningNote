...
public class ClassInfo {
   ...
   * @return The Method
   */
  public Method getSetter(String propertyName) throws Exception {
    Method method = (Method) setMethods.get(propertyName);
    if (method == null) {
      throw new Exception("There is no WRITEABLE property named '" + propertyName + "' in class '" + className + "'");
    }
    return method;
  }
   ...
   * @return The Method
   */
  public Method getGetter(String propertyName) throws Exception {
    Method method = (Method) getMethods.get(propertyName);
    if (method == null) {
      throw new Exception("There is no READABLE property named '" + propertyName + "' in class '" + className + "'");
    }
    return method;
  }
   ...
   */
  public Class getSetterType(String propertyName) throws Exception {
   ...
   */
  public Class getGetterType(String propertyName) throws Exception {
